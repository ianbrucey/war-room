    ...
    <div className="dropzone-section">
      ...
      >
        ...
        <h3 className="dropzone-title">
          {t('conversation.workspace.dragDropFiles', 'Drag and drop files here')}
        </h3>
        <p className="dropzone-subtitle">
          {t('common.or', 'or')}
        </p>
        <Button type="primary" size="large">
          {t('conversation.workspace.browseFiles', 'Browse Files')}
        </Button>
        <input
          ref={fileInputRef}
          type="file"
      ...
      <div className="supported-formats">
        {t('conversation.workspace.supportedFormats', 'Supported formats: PDF, DOCX, TXT, MD, JPG, PNG, MP3, WAV, M4A')}
      </div>
    </div>
  );
};
